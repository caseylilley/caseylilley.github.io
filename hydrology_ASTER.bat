...
SET od=W:\Open_Source\Wk4_BatchProcessing\Wk4_ASTER_num\%pre%
...
saga_cmd grid_tools 3 -GRIDS=ASTGTMV003_S03E037_dem.sgrd;ASTGTMV003_S04E037_dem.sgrd -NAME=%pre%Mosaic -TYPE=9 -RESAMPLING=1 -OVERLAP=1 -MATCH=0 -TARGET_OUT_GRID=%od%\%pre%mosaic.sgrd
