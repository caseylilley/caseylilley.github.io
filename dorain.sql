...
--Creating geometry for each table
...
--Update geometry for counties
update counties
set geometry = st_transform (geometry, 102004);

select Populate_Geometry_Columns ();

--Delete states not interested in 
...
--many Null values so default to 0 before merging
update counties 
set novembercount = 0;
...
--repeat with dorian (dorain due to typo)
